...
WORKING_TK = Path(r"D:\temp_tester\arb_system\python_executor\vendor_tk_from_working_exe")

a = Analysis(
    ['gui.py'],
    pathex=[r'D:\temp_tester\arb_system\python_executor'],
    binaries=[
    ...
    hookspath=['hooks'],
    hooksconfig={},
    runtime_hooks=[r'D:\temp_tester\arb_system\python_executor\tk_runtime_hook.py'],
    excludes=[],
    noarchive=False,
    optimize=0,
)
